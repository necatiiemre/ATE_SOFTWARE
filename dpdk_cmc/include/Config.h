...
// ==========================================
// DEBUG MODE (yalnızca Health Monitor çıktısı)
// ==========================================
// 0 = sadece özet/normal HM çıktısı (production).
// 1 = HM'de ek/ayrıntılı alanlar da basılır (ör. SW port'unun tüm sayaçları,
//     tüm portlar dahil). SADECE HM için — başlangıç otomasyonu ile ilgisi yok.
#ifndef DEBUG_MODE
#define DEBUG_MODE 1
#endif

// ==========================================
// CMC STARTUP AUTOMATION (HM DEBUG_MODE'dan ayrı)
// ==========================================
// dpdk_cmc uygulamasının başlangıç sekansını otomatikleştirir (ör. ATE test
// mode seçimini kullanıcıya sormadan otomatik yanıtlar). HM DEBUG_MODE'dan
// bağımsızdır — HM debug'ı açmak bu otomasyonu tetiklemez.
// 0 = interaktif (production), 1 = otomatik.
#ifndef CMC_AUTO_MODE
#define CMC_AUTO_MODE 1
#endif
