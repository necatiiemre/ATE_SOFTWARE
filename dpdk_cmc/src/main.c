...
// Health monitor disabled in CMC for now — see TxRxManager.c for the rx_worker
// call site and src/health_monitor/ for the source. CMC will get its own HM
// later; until then, no call sites reference it.
...
int main(int argc, char const *argv[])
{
    ...
    while (!force_quit)
    {
        ...
        // Health monitor dashboard disabled in CMC — see TxRxManager.c for
