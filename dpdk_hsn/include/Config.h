...
#ifndef PTP_ENABLED
#define PTP_ENABLED 0   // HSN: PTP removed
#endif
...
#define HEALTH_MONITOR_ENABLED 0   // HSN: Health Monitor removed
#endif
...
// ============================================================================
// HSN CONFIGURATION  (auto-derived from the verified spec)
// ----------------------------------------------------------------------------
// 30 device ports: D0-D3 (100G, swp1-4) + E0-E25 (10G, swp25s0-swp31s1).
// Cross-pair loopback: a VL entering device port X exits its cross-partner.
// 12 server ports P0-P11 (100G). Split TX/RX: a VL sent from a server port
// never returns to that same port.  Total 2048 VLs, VL-ID range 3-2050.
// ============================================================================

#define HSN_DEVICE_PORT_COUNT   30
#define HSN_SERVER_PORT_COUNT   12
#define HSN_VL_ID_START          3
#define HSN_VL_ID_END         2050
#define HSN_TOTAL_VL          2048
#define HSN_VL_COUNT_100G      304
#define HSN_VL_COUNT_10G        32
#define HSN_MAX_FLOWS_PER_PORT   4
#define HSN_INGRESS_VLAN_BASE  100
#define HSN_RETURN_VLAN_BASE   200

// TX packet-size pattern (payload bytes, count): 509-packet repeating cycle.
// 128-4096 equal bit share (32768 payload B each); jumbo 5000-9000 one each.
struct hsn_size_entry { uint16_t payload; uint16_t count; };
#define HSN_SIZE_PATTERN_LEN 11
#define HSN_SIZE_PATTERN_INIT {                                  \
    {128,256}, {256,128}, {512,64}, {1024,32}, {2048,16},        \
    {4096,8}, {5000,1}, {6000,1}, {7000,1}, {8000,1}, {9000,1} }
#define HSN_SIZE_CYCLE_PACKETS 509
#define HSN_MAX_PAYLOAD 9000

// Per device-port map (device-centric).
struct hsn_dev_port {
    uint16_t dev_id; uint16_t speed_gbps; uint16_t vl_start; uint16_t vl_count;
    uint16_t ingress_vlan; uint16_t return_vlan;
    uint16_t tx_srv; uint16_t rx_srv; uint16_t cross_partner;
};
#define HSN_DEV_PORT_MAP_INIT { \
    /* D0 <->D1  */ {.dev_id=0,.speed_gbps=100,.vl_start=3,.vl_count=304,.ingress_vlan=100,.return_vlan=201,.tx_srv=0,.rx_srv=1,.cross_partner=1}, \
    /* D1 <->D0  */ {.dev_id=1,.speed_gbps=100,.vl_start=307,.vl_count=304,.ingress_vlan=101,.return_vlan=200,.tx_srv=1,.rx_srv=0,.cross_partner=0}, \
    /* D2 <->D3  */ {.dev_id=2,.speed_gbps=100,.vl_start=611,.vl_count=304,.ingress_vlan=102,.return_vlan=203,.tx_srv=2,.rx_srv=3,.cross_partner=3}, \
    /* D3 <->D2  */ {.dev_id=3,.speed_gbps=100,.vl_start=915,.vl_count=304,.ingress_vlan=103,.return_vlan=202,.tx_srv=3,.rx_srv=2,.cross_partner=2}, \
    /* E0 <->E1  */ {.dev_id=4,.speed_gbps=10,.vl_start=1219,.vl_count=32,.ingress_vlan=104,.return_vlan=205,.tx_srv=4,.rx_srv=5,.cross_partner=5}, \
    /* E1 <->E0  */ {.dev_id=5,.speed_gbps=10,.vl_start=1251,.vl_count=32,.ingress_vlan=105,.return_vlan=204,.tx_srv=5,.rx_srv=4,.cross_partner=4}, \
    /* E2 <->E3  */ {.dev_id=6,.speed_gbps=10,.vl_start=1283,.vl_count=32,.ingress_vlan=106,.return_vlan=207,.tx_srv=4,.rx_srv=5,.cross_partner=7}, \
    /* E3 <->E2  */ {.dev_id=7,.speed_gbps=10,.vl_start=1315,.vl_count=32,.ingress_vlan=107,.return_vlan=206,.tx_srv=5,.rx_srv=4,.cross_partner=6}, \
    /* E4 <->E5  */ {.dev_id=8,.speed_gbps=10,.vl_start=1347,.vl_count=32,.ingress_vlan=108,.return_vlan=209,.tx_srv=4,.rx_srv=5,.cross_partner=9}, \
    /* E5 <->E4  */ {.dev_id=9,.speed_gbps=10,.vl_start=1379,.vl_count=32,.ingress_vlan=109,.return_vlan=208,.tx_srv=5,.rx_srv=4,.cross_partner=8}, \
    /* E6 <->E7  */ {.dev_id=10,.speed_gbps=10,.vl_start=1411,.vl_count=32,.ingress_vlan=110,.return_vlan=211,.tx_srv=4,.rx_srv=5,.cross_partner=11}, \
    /* E7 <->E6  */ {.dev_id=11,.speed_gbps=10,.vl_start=1443,.vl_count=32,.ingress_vlan=111,.return_vlan=210,.tx_srv=5,.rx_srv=4,.cross_partner=10}, \
    /* E8 <->E9  */ {.dev_id=12,.speed_gbps=10,.vl_start=1475,.vl_count=32,.ingress_vlan=112,.return_vlan=213,.tx_srv=6,.rx_srv=7,.cross_partner=13}, \
    /* E9 <->E8  */ {.dev_id=13,.speed_gbps=10,.vl_start=1507,.vl_count=32,.ingress_vlan=113,.return_vlan=212,.tx_srv=7,.rx_srv=6,.cross_partner=12}, \
    /* E10<->E11 */ {.dev_id=14,.speed_gbps=10,.vl_start=1539,.vl_count=32,.ingress_vlan=114,.return_vlan=215,.tx_srv=6,.rx_srv=7,.cross_partner=15}, \
    /* E11<->E10 */ {.dev_id=15,.speed_gbps=10,.vl_start=1571,.vl_count=32,.ingress_vlan=115,.return_vlan=214,.tx_srv=7,.rx_srv=6,.cross_partner=14}, \
    /* E12<->E13 */ {.dev_id=16,.speed_gbps=10,.vl_start=1603,.vl_count=32,.ingress_vlan=116,.return_vlan=217,.tx_srv=6,.rx_srv=7,.cross_partner=17}, \
    /* E13<->E12 */ {.dev_id=17,.speed_gbps=10,.vl_start=1635,.vl_count=32,.ingress_vlan=117,.return_vlan=216,.tx_srv=7,.rx_srv=6,.cross_partner=16}, \
    /* E14<->E15 */ {.dev_id=18,.speed_gbps=10,.vl_start=1667,.vl_count=32,.ingress_vlan=118,.return_vlan=219,.tx_srv=8,.rx_srv=9,.cross_partner=19}, \
    /* E15<->E14 */ {.dev_id=19,.speed_gbps=10,.vl_start=1699,.vl_count=32,.ingress_vlan=119,.return_vlan=218,.tx_srv=9,.rx_srv=8,.cross_partner=18}, \
    /* E16<->E17 */ {.dev_id=20,.speed_gbps=10,.vl_start=1731,.vl_count=32,.ingress_vlan=120,.return_vlan=221,.tx_srv=8,.rx_srv=9,.cross_partner=21}, \
    /* E17<->E16 */ {.dev_id=21,.speed_gbps=10,.vl_start=1763,.vl_count=32,.ingress_vlan=121,.return_vlan=220,.tx_srv=9,.rx_srv=8,.cross_partner=20}, \
    /* E18<->E19 */ {.dev_id=22,.speed_gbps=10,.vl_start=1795,.vl_count=32,.ingress_vlan=122,.return_vlan=223,.tx_srv=8,.rx_srv=9,.cross_partner=23}, \
    /* E19<->E18 */ {.dev_id=23,.speed_gbps=10,.vl_start=1827,.vl_count=32,.ingress_vlan=123,.return_vlan=222,.tx_srv=9,.rx_srv=8,.cross_partner=22}, \
    /* E20<->E21 */ {.dev_id=24,.speed_gbps=10,.vl_start=1859,.vl_count=32,.ingress_vlan=124,.return_vlan=225,.tx_srv=10,.rx_srv=11,.cross_partner=25}, \
    /* E21<->E20 */ {.dev_id=25,.speed_gbps=10,.vl_start=1891,.vl_count=32,.ingress_vlan=125,.return_vlan=224,.tx_srv=11,.rx_srv=10,.cross_partner=24}, \
    /* E22<->E23 */ {.dev_id=26,.speed_gbps=10,.vl_start=1923,.vl_count=32,.ingress_vlan=126,.return_vlan=227,.tx_srv=10,.rx_srv=11,.cross_partner=27}, \
    /* E23<->E22 */ {.dev_id=27,.speed_gbps=10,.vl_start=1955,.vl_count=32,.ingress_vlan=127,.return_vlan=226,.tx_srv=11,.rx_srv=10,.cross_partner=26}, \
    /* E24<->E25 */ {.dev_id=28,.speed_gbps=10,.vl_start=1987,.vl_count=32,.ingress_vlan=128,.return_vlan=229,.tx_srv=10,.rx_srv=11,.cross_partner=29}, \
    /* E25<->E24 */ {.dev_id=29,.speed_gbps=10,.vl_start=2019,.vl_count=32,.ingress_vlan=129,.return_vlan=228,.tx_srv=11,.rx_srv=10,.cross_partner=28}, \
}

// Per server-port config (server-centric): flows each port TX/RX.
struct hsn_flow { uint16_t vlan; uint16_t vl_start; uint16_t vl_count; uint16_t dev_port; };
struct hsn_srv_port {
    uint16_t srv_id;
    uint16_t tx_flow_count; struct hsn_flow tx[HSN_MAX_FLOWS_PER_PORT];
    uint16_t rx_flow_count; struct hsn_flow rx[HSN_MAX_FLOWS_PER_PORT];
};
#define HSN_SRV_PORT_CONFIG_INIT { \
    {.srv_id=0, .tx_flow_count=1, .tx={ {.vlan=100,.vl_start=3,.vl_count=304,.dev_port=0} }, .rx_flow_count=1, .rx={ {.vlan=200,.vl_start=307,.vl_count=304,.dev_port=1} }}, \
    {.srv_id=1, .tx_flow_count=1, .tx={ {.vlan=101,.vl_start=307,.vl_count=304,.dev_port=1} }, .rx_flow_count=1, .rx={ {.vlan=201,.vl_start=3,.vl_count=304,.dev_port=0} }}, \
    {.srv_id=2, .tx_flow_count=1, .tx={ {.vlan=102,.vl_start=611,.vl_count=304,.dev_port=2} }, .rx_flow_count=1, .rx={ {.vlan=202,.vl_start=915,.vl_count=304,.dev_port=3} }}, \
    {.srv_id=3, .tx_flow_count=1, .tx={ {.vlan=103,.vl_start=915,.vl_count=304,.dev_port=3} }, .rx_flow_count=1, .rx={ {.vlan=203,.vl_start=611,.vl_count=304,.dev_port=2} }}, \
    {.srv_id=4, .tx_flow_count=4, .tx={ {.vlan=104,.vl_start=1219,.vl_count=32,.dev_port=4}, {.vlan=106,.vl_start=1283,.vl_count=32,.dev_port=6}, {.vlan=108,.vl_start=1347,.vl_count=32,.dev_port=8}, {.vlan=110,.vl_start=1411,.vl_count=32,.dev_port=10} }, .rx_flow_count=4, .rx={ {.vlan=204,.vl_start=1251,.vl_count=32,.dev_port=5}, {.vlan=206,.vl_start=1315,.vl_count=32,.dev_port=7}, {.vlan=208,.vl_start=1379,.vl_count=32,.dev_port=9}, {.vlan=210,.vl_start=1443,.vl_count=32,.dev_port=11} }}, \
    {.srv_id=5, .tx_flow_count=4, .tx={ {.vlan=105,.vl_start=1251,.vl_count=32,.dev_port=5}, {.vlan=107,.vl_start=1315,.vl_count=32,.dev_port=7}, {.vlan=109,.vl_start=1379,.vl_count=32,.dev_port=9}, {.vlan=111,.vl_start=1443,.vl_count=32,.dev_port=11} }, .rx_flow_count=4, .rx={ {.vlan=205,.vl_start=1219,.vl_count=32,.dev_port=4}, {.vlan=207,.vl_start=1283,.vl_count=32,.dev_port=6}, {.vlan=209,.vl_start=1347,.vl_count=32,.dev_port=8}, {.vlan=211,.vl_start=1411,.vl_count=32,.dev_port=10} }}, \
    {.srv_id=6, .tx_flow_count=3, .tx={ {.vlan=112,.vl_start=1475,.vl_count=32,.dev_port=12}, {.vlan=114,.vl_start=1539,.vl_count=32,.dev_port=14}, {.vlan=116,.vl_start=1603,.vl_count=32,.dev_port=16} }, .rx_flow_count=3, .rx={ {.vlan=212,.vl_start=1507,.vl_count=32,.dev_port=13}, {.vlan=214,.vl_start=1571,.vl_count=32,.dev_port=15}, {.vlan=216,.vl_start=1635,.vl_count=32,.dev_port=17} }}, \
    {.srv_id=7, .tx_flow_count=3, .tx={ {.vlan=113,.vl_start=1507,.vl_count=32,.dev_port=13}, {.vlan=115,.vl_start=1571,.vl_count=32,.dev_port=15}, {.vlan=117,.vl_start=1635,.vl_count=32,.dev_port=17} }, .rx_flow_count=3, .rx={ {.vlan=213,.vl_start=1475,.vl_count=32,.dev_port=12}, {.vlan=215,.vl_start=1539,.vl_count=32,.dev_port=14}, {.vlan=217,.vl_start=1603,.vl_count=32,.dev_port=16} }}, \
    {.srv_id=8, .tx_flow_count=3, .tx={ {.vlan=118,.vl_start=1667,.vl_count=32,.dev_port=18}, {.vlan=120,.vl_start=1731,.vl_count=32,.dev_port=20}, {.vlan=122,.vl_start=1795,.vl_count=32,.dev_port=22} }, .rx_flow_count=3, .rx={ {.vlan=218,.vl_start=1699,.vl_count=32,.dev_port=19}, {.vlan=220,.vl_start=1763,.vl_count=32,.dev_port=21}, {.vlan=222,.vl_start=1827,.vl_count=32,.dev_port=23} }}, \
    {.srv_id=9, .tx_flow_count=3, .tx={ {.vlan=119,.vl_start=1699,.vl_count=32,.dev_port=19}, {.vlan=121,.vl_start=1763,.vl_count=32,.dev_port=21}, {.vlan=123,.vl_start=1827,.vl_count=32,.dev_port=23} }, .rx_flow_count=3, .rx={ {.vlan=219,.vl_start=1667,.vl_count=32,.dev_port=18}, {.vlan=221,.vl_start=1731,.vl_count=32,.dev_port=20}, {.vlan=223,.vl_start=1795,.vl_count=32,.dev_port=22} }}, \
    {.srv_id=10, .tx_flow_count=3, .tx={ {.vlan=124,.vl_start=1859,.vl_count=32,.dev_port=24}, {.vlan=126,.vl_start=1923,.vl_count=32,.dev_port=26}, {.vlan=128,.vl_start=1987,.vl_count=32,.dev_port=28} }, .rx_flow_count=3, .rx={ {.vlan=224,.vl_start=1891,.vl_count=32,.dev_port=25}, {.vlan=226,.vl_start=1955,.vl_count=32,.dev_port=27}, {.vlan=228,.vl_start=2019,.vl_count=32,.dev_port=29} }}, \
    {.srv_id=11, .tx_flow_count=3, .tx={ {.vlan=125,.vl_start=1891,.vl_count=32,.dev_port=25}, {.vlan=127,.vl_start=1955,.vl_count=32,.dev_port=27}, {.vlan=129,.vl_start=2019,.vl_count=32,.dev_port=29} }, .rx_flow_count=3, .rx={ {.vlan=225,.vl_start=1859,.vl_count=32,.dev_port=24}, {.vlan=227,.vl_start=1923,.vl_count=32,.dev_port=26}, {.vlan=229,.vl_start=1987,.vl_count=32,.dev_port=28} }}, \
}
